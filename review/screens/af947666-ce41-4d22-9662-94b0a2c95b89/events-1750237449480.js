jQuery("#simulation")
  .on("click", ".s-af947666-ce41-4d22-9662-94b0a2c95b89 .click", function(event, data) {
  ...
  .on("mouseenter dragenter", ".s-af947666-ce41-4d22-9662-94b0a2c95b89 .mouseenter", function(event, data) {
    var jEvent, jFirer, cases;
    if(jimUtil.isAlternateModeActive()) return;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
  ...
  .on("mouseleave dragleave", ".s-af947666-ce41-4d22-9662-94b0a2c95b89 .mouseleave", function(event, data) {
    var jEvent, jFirer, cases;
    if(jimUtil.isAlternateModeActive()) return;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
